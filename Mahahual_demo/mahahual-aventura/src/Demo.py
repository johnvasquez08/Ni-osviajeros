    ...
    def _animar_imagen_central(self, dt):
        ...
        if self.imagen_central_moviendo and self.parpadeo_activo:
            ...
            if y < target_y:
                ...
                self.imagen_central.pos = (-999, -999)
    ...
    def on_touch_move(self, touch):
        if self.arrastrando:
            ...
            if len(self.huevos_descubiertos) == len(self.huevos):
                ...
                self.imagen_central_activable = True
            else:
...
class MenuScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.sonido_boton1 = SoundLoader.load("Inicio.wav")
        self.sonido_boton2 = SoundLoader.load("Salida.wav")
